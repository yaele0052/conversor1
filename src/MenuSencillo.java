...
//Es necesario importar esta libreria para que podamos llamar cuadros de dialogo//
public class MenuSencillo {
	public static void main(String[] args) {
		/*
		 * JOptionPane.ERROR_MESSAGE. -----> 0 JoptionPane.INFORMATION_MESSAGE.-----> 1
		 * JOptionPane-WARNING_MESSAGE. -----> 2 JOptionPane.QUESTION_MESSAGE. ----> 3
		 * Estos son los diferentes iconos que podemos ponerle al cuadro de dialogo
		 * dependiendo que es lo que necesitemos
		 * 
		 * // En este caso con este comando lo que hacemos es configurar nuestro cuadro
		 * de // dialogo mostrado, comenzamos colocando un null, posteriormente el
		 * argumento // de nuestro cuadro, el siguiente atributo asigna el nombre del
		 * cuadro de // dialogo y el ultimo es el tipo de cuado (de los mencionados
		 * arriba//
		 * 
		 * String valor = JOptionPane.showInputDialog(null, "Ingrese un nombre",
		 * "Nombre", 3); JOptionPane.showMessageDialog(null, "Tienes " + valor +
		 * " Hijos?", "Mi mensaje", 3);
		 * 
